...
public class RealTimeChartECPU extends ChartPanel {
	private static Logger logger = Logger.getLogger(RealTimeChartECPU.class);
	...
	public void addSery(float ratio) {
		...
		logger.debug("ECPU:       mili = " + mili + "           ratio = " + ratio);
	}

	public RealTimeChartECPU(String yaxisName, Double timeLen) {

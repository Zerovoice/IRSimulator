...
public class RealTimeChartRMem extends ChartPanel {
	private static Logger logger = Logger.getLogger(RealTimeChartRMem.class);
	...
	public void addSery(float ratio) {
		...
		logger.debug("RMem:      mili = " + mili + "           ratio = " + ratio);
	}

	public RealTimeChartRMem(String yaxisName, Double timeLen) {

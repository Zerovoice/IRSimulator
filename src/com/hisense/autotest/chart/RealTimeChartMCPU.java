...
public class RealTimeChartMCPU extends ChartPanel {
	private static Logger logger = Logger.getLogger(RealTimeChartMCPU.class);

	private static final long serialVersionUID = 1L;

	private static TimeSeries timeSeries;

	public void addSery(Millisecond mili, float ratio) {
		timeSeries.addOrUpdate(mili, ratio);
		logger.debug("MCPU:    mili = " + mili + "           ratio = " + ratio);
	}
	...
	public RealTimeChartMCPU(String yaxisName, Double timeLen) {

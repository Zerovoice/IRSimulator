...
public class RealTimeChartMMem extends ChartPanel {
	private static Logger logger = Logger.getLogger(RealTimeChartMMem.class);
	...
	public void addSery(float ratio) {
		...
		logger.debug("MMem:      mili = " + mili + "           ratio = " + ratio);
	}

	public RealTimeChartMMem(String yaxisName, Double timeLen) {
